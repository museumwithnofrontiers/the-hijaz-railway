...
import partnerNamesEn from '@museumwnf/the-hijaz-railway-data/translations/partners.en.json'
import dynastyNamesEn from '@museumwnf/the-hijaz-railway-data/translations/dynasties.en.json'
...
describe('website smoke test', () => {
  ...
  it('renders the shared texts and its own over them', async () => {
    ...
    expect(checkTextsRendered(host, {
      namespaces: ['theHijazRailway', 'core', 'layout', 'catalogue', 'record', 'sheet', 'timeline', 'partner', 'exhibition'],
    })).toEqual([])
