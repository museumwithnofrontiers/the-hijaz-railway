...
The **Museum With No Frontiers — The Hijaz Railway** exhibition, built from the published
dataset `@museumwnf/the-hijaz-railway-data`.
...
| Package | Role |
| --- | --- |
| `@museumwnf/the-hijaz-railway-data` | the dataset (JSON + `manifest.json`) |
...
<https://museumwithnofrontiers.github.io/the-hijaz-railway/> through the reusable workflows in
