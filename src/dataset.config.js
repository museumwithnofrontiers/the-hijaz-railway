...
const about = {
  body: 'theHijazRailway.about.body',
...
export default {
  ...
  siteName: manifest.site?.names?.en ?? 'the-hijaz-railway',
  ...
  home: {
    title: 'theHijazRailway.identity.title',
    intro: 'theHijazRailway.home.intro',
    cards: [
      {
        title: 'theHijazRailway.nav.catalogue',
        description: 'theHijazRailway.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'theHijazRailway.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'theHijazRailway.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'theHijazRailway.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //
  //   extraViews: [
  //     ...standardRoutes('gallery', { creditsBody: 'theHijazRailway.credits.body' }),
  ...
  //       partnerObjects: {
  //         emptyPartner: 'theHijazRailway.partnerObjects.emptyPartner',
  //         emptyInstitution: 'theHijazRailway.partnerObjects.emptyInstitution',
  //         institutionSummary: 'theHijazRailway.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'theHijazRailway.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'theHijazRailway.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance
