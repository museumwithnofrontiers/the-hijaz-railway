...
// (`npm pack @museumwnf/the-hijaz-railway-data`) — never the legacy project
...
export const projectColors = {
  ...
  'e08d1c71-8cff-5fe9-b480-2ae6c530b732': 'exhibition', // The Hijaz Railway (this exhibition's own project, or borrowed from another exhibition — shares the 'exhibition' family)
}
...
export default {
  ...
  site: { origin: 'https://museumwithnofrontiers.github.io/the-hijaz-railway' },
